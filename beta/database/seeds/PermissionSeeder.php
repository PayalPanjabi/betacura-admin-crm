...
class PermissionSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        //expense leads
        $expense_leads_module=Module::Create([
            'name'=>'expense leads'
        ]);
        ...
        [
            [
                'module_id'=>$expense_leads_module['id'],
                'key'=>'view_expense_leads',
                'name'=>'View'
            ],
            [
                'module_id'=>$expense_leads_module['id'],
                'key'=>'create_expense_leads',
                'name'=>'Create'
            ],
            [
                'module_id'=>$expense_leads_module['id'],
                'key'=>'edit_expense_leads',
                'name'=>'Edit'
            ],
            [
                'module_id'=>$expense_leads_module['id'],
                'key'=>'delete_expense_leads',
                'name'=>'Delete'
            ],
        ]  
        );
