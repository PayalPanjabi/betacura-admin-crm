<div class="row">
    ...
    <div class="col-lg-3">
        ...
        <select name="disposition" placeholder="{{__('Disposition')}}" 
            class="form-control select2" onchange="showDiv('hidden_div', this)" required>
            ...
            <option value="reschedule_call">Reschedule Call</option>
            <option value="Others">Others</option>
        </select>
    </div>
    <div id="hidden_div" class="col-lg-6">
        <label for="date">{{__('Reschedule Date')}}</label>
        <input type="date" class="form-control" placeholder="{{__('Date')}}" name="date" 
        @if(isset($lead)) value="{{$lead['date']}}" @endif required>
    </div> 
    ...
    <div class="col-lg-3">
        ...
        <select name="time-slots" placeholder="{{__('Time Slots')}}" 
            class="form-control select2" required>
            <option value="">Select</option>
            <option value="pune">6 to 7 PM</option>
            <option value="pune">7 to 6 AM</option>
        </select>
    </div>
    <div class="col-lg-3">
...
<script>
    ...
    {
        document.getElementById(divId).style.display = element.value == 'reschedule_call' ? 'block' : 'none';
    }
</script>