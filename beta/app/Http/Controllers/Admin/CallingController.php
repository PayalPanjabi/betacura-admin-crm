...
class CallingController extends Controller
{
    ...
    {
        // $this->middleware('can:view_leads',     ['only' => ['index', 'show','ajax']]);
        // $this->middleware('can:create_leads',   ['only' => ['create', 'store']]);
        // $this->middleware('can:edit_leads',     ['only' => ['edit', 'update']]);
        // $this->middleware('can:delete_leads',   ['only' => ['destroy','bulk_delete']]);
    }
    ...
    {
        return view('admin.calling.create');
     ...
     * @return \Illuminate\Http\Response
     */
    public function callingdetails()
    {

        return view('admin.calling.callingdetails');
    ...
    public function store(CategoryRequest $request)
    {
        ...
        return redirect()->route('admin.calling.index');
    }
